  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3 className="text-lg sm:text-xl font-semibold mb-5 text-sky-300 group-hover:text-sky-200 transition-colors">
        ...
        >
          <h3 className="text-lg sm:text-xl font-semibold mb-5 text-purple-300 group-hover:text-purple-200 transition-colors">
            Backend Development
          </h3>
        ...
        >
          <h3 className="text-lg sm:text-xl font-semibold mb-5 text-emerald-300 group-hover:text-emerald-200 transition-colors">
            Tools & DevOps
          </h3>
