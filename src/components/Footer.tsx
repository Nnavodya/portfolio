...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "GitHub", icon: FaGithub, url: "https://github.com/Nnavodya" },
    { name: "LinkedIn", icon: FaLinkedin, url: "https://www.linkedin.com/in/nethmi-rajapaksha-465335359" },
    { name: "Instagram", icon: FaInstagram, url: "https://instagram.com/nethmi2988" },
    { name: "Email", icon: FaEnvelope, url: "mailto:nethmirajapaksha038@gmail.com" },
  ];
            ...
            <nav className="flex flex-col gap-2 text-center sm:text-left">
              {quickLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition"
                >
                  {link.label}
                </a>
              ))}
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="p-2 rounded-full bg-gray-200 dark:bg-gray-900/10 hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white transition hover:scale-110 duration-200 text-gray-700 dark:text-gray-300"
                    title={social.name}
                  >
      ...
      <div className="p-4 sm:p-6 text-center">
        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
          ...
          <span className="block sm:inline">
            ...
            <span className="text-sky-500 dark:text-sky-400">Tailwind CSS</span>
          </span>
        </p>
      </div>
    </footer>
